...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', '$document', '$interval',
    function($scope, FabricWindow, $window, filterFontFilter, filterArtFilter, $timeout, $http, $document, $interval){
    $scope.stages = [];
    var d = new Date(),
    t = d.getTime();
    ...
    $scope.initSettings = async function(){
        ...
        $scope.settings.active_cliparts = (!$scope.settings.active_design && !$scope.settings.active_template && !$scope.settings.active_typos && NBDESIGNCONFIG.nbdesigner_enable_clipart) ? true : false;
        $scope.settings.active_photos = (!$scope.settings.active_design && !$scope.settings.active_template && !$scope.settings.active_typos && !$scope.settings.active_cliparts && NBDESIGNCONFIG.nbdesigner_enable_image) ? true : false;
        ...
        $scope.settings.active_elements = (!$scope.settings.active_design && !$scope.settings.active_template && !$scope.settings.active_typos && !$scope.settings.active_cliparts && !$scope.settings.active_photos && $scope.settings.show_elements_tab && !NBDESIGNCONFIG.nbdesigner_hide_element_tab) ? true : false;
        $scope.settings.active_layers = (!$scope.settings.active_design && !$scope.settings.active_template && !$scope.settings.active_typos && !$scope.settings.active_cliparts && !$scope.settings.active_photos && !$scope.settings.active_elements && !NBDESIGNCONFIG.nbdesigner_hide_layer_tab) ? true : false;
        ...
        if( NBDESIGNCONFIG.product_data.option.admindesign != true && $scope.settings.nbdesigner_enable_text == false && $scope.settings.nbdesigner_enable_clipart ){

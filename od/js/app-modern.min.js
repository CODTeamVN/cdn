...
nbdApp.controller('designCtrl', ['$scope', 'FabricWindow', '$window', 'filterFontFilter', 'filterArtFilter', '$timeout', '$http', '$document', '$interval',
        ...
        if( NBDESIGNCONFIG.task == 'edit' ){
            const getConfig = () => {
                return new Promise((resolve, reject) => {
                    $http({
                        method: 'GET',
                        url: `${NBDESIGNCONFIG.baseUrl}/${NBDESIGNCONFIG.currentTemplate.path}config.json`,
    ...
    $scope.saveData = async function(type){
        ...
        async function _saveData (){
            ...
            if( type == 'create' ) $scope.resource.jsonDesign.canvas = {width: $scope.templateSize.width, height: $scope.templateSize.height};
